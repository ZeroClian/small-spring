...
import cn.zeroclian.springframework.beans.factory.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object createBean(String beanName, BeanDefinition beanDefinition, Object[] args) throws BeansException {
        ...
        try {
            ...
            bean = initialization(beanName, bean, beanDefinition);
        } catch (Exception e) {
    ...
    protected void registerDisposableBeanIfNecessary(String beanName, Object bean, BeanDefinition beanDefinition) {
        if (bean instanceof DisposableBean || StrUtil.isNotEmpty(beanDefinition.getDestroyMethodName())) {
            registerDisposableBean(beanName, new DisposableBeanAdaptot(bean, beanName, beanDefinition));
        }
    }
    ...
    private Object initialization(String beanName, Object bean, BeanDefinition beanDefinition) {
    ...
    private void invokeInitMethods(String beanName, Object bean, BeanDefinition beanDefinition) throws Exception {
        ...
        //配置信息 init-method {判断是为了避免二次执行而销毁}
